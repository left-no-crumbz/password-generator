import string, secrets, customtkinter, time
...
class Password_Generator:
    def __init__(self):
        ...
        self.password_length = customtkinter.CTkSlider(master=self.frame, from_=4, to=50, orientation='horizontal', hover=True, command=self.generate_password)
        ...
        # self.checkboxes.get("Letters") = customtkinter.BooleanVar(value=True)
        # self.check_number = customtkinter.BooleanVar(value=True)
        # self.check_special = customtkinter.BooleanVar(value=True)
